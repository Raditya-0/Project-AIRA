...
namespace AIRA.MiniGames.SpaceShooter
{
    public class ShipHealthBar : MonoBehaviour
    {
        ...
        {
            GameEvents.Instance.onPlayerDamage += OnHealthChanged;
            GameEvents.Instance.onPlayerHeal   += OnHealthChanged;
        ...
        private void UpdateFillAmount()
        {
            ...
            float max = m_healthManager.GetMaxHealth();
            m_fillImage.fillAmount = max > 0f ? m_healthManager.GetCurrentHealth() / max : 0f;
        }
